...
export class UserProblemSubmissionComponent implements OnInit{
  constructor(private submitProblemService:SubmitProblemService, private loginService: LoginService) {}
  submissions:any;
  user:any;
  ngOnInit(): void {
    this.user= this.loginService.getUser();
    this.submitProblemService.getAllUserSubmission(this.user.id).subscribe((data)=>{
